...
![image](https://user-images.githubusercontent.com/107028312/209335602-6aec6910-51d4-4e25-80ed-a940152bbfca.png)
...
|Axios|서버와의 통신을 위해 뛰어난 브라우저 호환성을 가지고 있어 제한 조건이 없고 ResponseTimeOut 등과 같이 Fetch에 비해 상대적으로 다양한 기능을 제공해주고 있는 promise기반의 비동기 처리가 가능한 Axios를 사용했다.|
|ReduxToolkit|데이터를 localStorage나 props만으로 관리하기 힘들어 전역으로 관리해줄 방법이 필요했고 전역상태관리로 데이터를 수월하게 관리할 수 있는 Redux중에서도 미들웨어를 추가하기 용이하고 코드가 매우 간결해지는 장점이 있는 ReduxToolkit을 사용했다.|
